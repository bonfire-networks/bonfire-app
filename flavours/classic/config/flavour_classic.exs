...
config :bonfire_boundaries, Bonfire.UI.Boundaries.Web.SetBoundariesLive, modularity: :disabled
config :bonfire_boundaries, Bonfire.UI.Boundaries.Web.PreviewBoundariesLive, modularity: :disabled
