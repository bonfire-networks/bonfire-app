...
config :bonfire_data_social, Activity,
  [code: quote do
    ...
    has_one :activity, unquote(Activity), foreign_key: :id, references: :id # ugly workaround needed for querying
    # field :target_feeds, {:array, :any}, virtual: true # used in changesets

    has_one :like_count, unquote(EdgeTotal),
      foreign_key: :id, references: :object_id, where: [table_id: @like_ulid]
    has_one :boost_count, unquote(EdgeTotal),
      foreign_key: :id, references: :object_id, where: [table_id: @boost_ulid]
    has_one :follow_count, unquote(EdgeTotal),
      foreign_key: :id, references: :object_id, where: [table_id: @follow_ulid]
