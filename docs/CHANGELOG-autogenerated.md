...
- 🚧 add migration of user's activities (such as posts) when moving instance [#1528](https://github.com/bonfire-networks/bonfire-app/issues/1528) [`bebc13d`](https://github.com/bonfire-networks/activity_pub/commit/bebc13da59a4a718d9ca91f10faf4c3f0a2a463a) (thanks @mayel)
