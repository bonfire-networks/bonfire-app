...
- 🐛 A "Welcome Back" button is hidding the "Create" button for accounts [#2178](https://github.com/bonfire-networks/bonfire-app/issues/2178) (thanks @ju1m, @mayel, and @ivanminutillo)
