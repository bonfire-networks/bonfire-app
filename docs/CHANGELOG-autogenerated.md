...
- ✨ URL previews are not generated for remote (federated) posts, like they are for local posts [#1291](https://github.com/bonfire-networks/bonfire-app/issues/1291) (thanks @ivanminutillo and @mayel)
