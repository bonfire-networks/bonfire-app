...
[🔗](https://github.com/bonfire-networks/bonfire-app/blob/main/lib/bonfire/api/graphql/graphql_schema.ex#L252)
...
# `maybe_schema_to_api_type`

# `schema_to_api_type`

# `schema_to_api_type_fallback`
