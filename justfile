...
@_flavour_install select_flavour *args='':
	{{ if path_exists("extensions/{{select_flavour}}/install.sh")=="true" { "chmod +x extensions/"+select_flavour+"/install.sh && ./extensions/"+select_flavour+"/install.sh {{args}}" } else {"chmod +x deps/"+select_flavour+"/install.sh && ./deps/"+select_flavour+"/install.sh {{args}}"} }}
